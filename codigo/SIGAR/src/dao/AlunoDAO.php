...
class AlunoDAO {
    ...
    public function deletarAluno($idPessoaAluno) {
        ...
        $idEndereco = $this->selecionarIdEndereco($idPessoaAluno);
    ...
    public function deletarResponsavel($idPessoaResponsavel) {
        ...
        $idResponsavel =0;
        while ($aux = mysql_fetch_array($resultadoBusca)) {
            $idResponsavel = $aux['idResponsavel'];
        }
        ...
        $idEndereco = $this->selecionarIdEndereco($idPessoaResponsavel);
    ...
    public function selecionarIdEndereco($idPessoa){
        
        $sql = "SELECT  `endereco_pessoa`.`idEndereco` FROM  `sigar`.`endereco_pessoa` WHERE  `endereco_pessoa`.`idPessoa` =" . $idPessoa . ";";
