...
//Atributo para checagem de erro
    ...
    function valida_ano_escolar() {
        if (empty($this->_ano_escolar)) {
            $this->_res_ano_escolar = "<b><font color=red> * </font>Favor informar ano escolar";
            $this->_erro = 1;
        }
    }

    function valida_escola() {
        if (empty($this->_escola)) {
    ...
    function valida_logradouro() {
        if (empty($this->_logradouro)) {
            $this->_res_logradouro = "<b><font color=red> * </font>Favor digitar o logradouro.";
            $this->_erro = 1;
        }
    }

    function valida numero_casa() {
