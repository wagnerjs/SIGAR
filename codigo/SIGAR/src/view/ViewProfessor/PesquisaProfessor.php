                            ...
                            <table border="1" id="table_example">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td style='cursor: pointer; text-align: center;'><a href="http://localhost/SIGAR/codigo/SIGAR/src/view/ViewProfessor/DisponibilidadeProfessor.php?professorID=<?php echo mysql_result($professorCtrl->getResposta(),$i,'idProfessor');?>"><img src='../img/icon-calendar.png' onClick="" alt="Deletar"></a></td>
                                    </tr>
                                    <?php
                                        }
                                    }
